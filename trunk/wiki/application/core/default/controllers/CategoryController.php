...
class CategoryController extends Zend_Controller_Action
{
	...
	public function editAction()
	{
		...
		if ($this->getRequest ()->isPost ()) {
			if ($frmCate->isValid ( $_POST )) {
				$cateName = $frmCate->getValue ( 'cate_name' );
			...
			$frmCate->getElement ( 'cate_name' )->setValue ( $currentCate->name );
		}
		$frmCate->setAction ( '/' . BLOGGER_NAME . '/category/edit' );
	...
	public function moveAction() {
		...
		$mdlCategory = new Application_Model_DbTable_Category ();
		if ($direction == 'up') {
